...
export const register = async (req, res) => {
  try {
    ...
    await sendMail(email, "Verify your acc", `Your OTP is ${otp}`);
    sendToken(res, user, 200, "OTP sent to your email,please verify your acc");
  } catch (error) {
...
export const forgetPassword = async (req, res) => {
  try {
    ...
    await user.save();
    await sendMail(email, `Your OTP to reset the password is ${otp}`);
    res
      .status(200)
